...
\gdef\@defensedate{01/11/2019}% Default is a long time from now.
\gdef\@committee{
  Paul Wilson, Professor, Nuclear Engineering, UW-Madison\\
  James Blanchard, Executive Associate Dean, College of Engineering, UW-Madison\\
  Gregory Nellis, Professor, Mechanical Engineering, UW-Madison
  }
...
%-----------------------------------------------------------------------------
    ...
    \hspace*{-0.7in}The thesis is approved by the following members of the 
