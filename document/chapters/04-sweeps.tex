\section{Neutronic Constraints} \label{sec:sweeps}
...
\subsection{Neutronics Conclusion}
The figure of merit for a neutronics constraint was EOL \keff. The reactor must
...
important was that EOL \keff is relatively independent of thermal power. This
means EOL \keff can be estimated as BOL \keff adjusted for minimal depletion.
This conclusion was useful to constrain reactor parameters and will be utilized
in Chapter \ref{critical_radius}

These conclusions was used to simplify the modeling space for neutronics
constraints. EOL \keff is directly related to BOl \keff which is strongly
predicted by fuel mass. These assumptions were leveraged in Chapter
\ref{critical_radius} to generate a relationship between core fuel fraction
