...
orbit. As a consequence it is crucial to minimze system mass when designing a terrestrial electrical system for
solar system exploration. To this end, a surrogate mass model of a small fission
...
\section{Scope}
The purpose of this project was not to develop a fully-fledged reactor concept.
...
integrate into an optmization routine. To support the opwer system mass optimization, this project focused on
...
technical readiness. The use of igh enriched uranium was acceptable. 
The reactor is be direct-cooled, and coupled to a
...
generators were stacked together for a combined thermal power of 4410 Wth. The
...
result, a fission power, with more readily available fuel and higher conversiont
